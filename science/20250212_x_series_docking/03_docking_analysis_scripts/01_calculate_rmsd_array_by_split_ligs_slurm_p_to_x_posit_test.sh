...
#SBATCH --mem=128GB
#SBATCH --time=0:00:10
#SBATCH --array=173  # Array jobs range (for jobs 1 through n)
...
-d "/data1/choderaj/paynea/asap-datasets/20250212_p_to_x_posit/${SLURM_ARRAY_TASK_ID}" \
...
-o "/data1/choderaj/paynea/asap-datasets/20250212_p_to_x_posit/rmsd_csvs/${SLURM_ARRAY_TASK_ID}.csv"
