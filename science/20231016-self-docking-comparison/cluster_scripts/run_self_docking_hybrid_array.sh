...
#BSUB -oo run_self_hybrid_%I.out
#BSUB -eo run_self_hybrid_%I.stderr
#BSUB -n 1
#BSUB -q cpuqueue
#BSUB -R rusage[mem=4]
#BSUB -W 0:10
...
-o /lila/data/chodera/asap-datasets/retro_docking/sars_fragalysis_retrospective/20230919_self_docked_hybrid_p_only \
-n 1 \
--docking_sys posit \
--omega \
--relax clash \
