...
#BSUB -oo run_self_docking_shapefit_2d_%I.out
#BSUB -eo run_self_docking_shapefit_2d_%I.stderr
#BSUB -n 1
#BSUB -q cpuqueue
#BSUB -R rusage[mem=4]
#BSUB -W 0:10
...
-o /lila/data/chodera/asap-datasets/retro_docking/sars_fragalysis_retrospective/20231016_self_docked_shapefit_p_only_2d \
-n 1 \
--docking_sys posit \
--omega \
--relax clash \
