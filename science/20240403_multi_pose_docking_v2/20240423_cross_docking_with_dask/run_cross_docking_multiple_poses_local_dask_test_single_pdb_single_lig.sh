...
#BSUB -J "single_pair_test"
#BSUB -oo logs/single_pair_test.out
#BSUB -eo logs/single_pair_test.stderr
#BSUB -n 8
#BSUB -m lt-gpu
#BSUB -R "span[hosts=1]"
...
--use-only-cache \
--output-dir "/lila/data/chodera/asap-datasets/retro_docking/sars_fragalysis_retrospective/20240423_multi_pose_docking_cross_docking/" \
--no-overwrite \
--num-poses 50 \
--use-dask \
--dask-type local \
