...
#BSUB -eo array_logs/run_self_docking_multiple_poses_%I.stderr
#BSUB -n 1
#BSUB -q cpuqueue
#BSUB -R rusage[mem=4]
#BSUB -W 0:10
...
--use-only-cache \
--output-dir "/lila/data/chodera/asap-datasets/retro_docking/sars_fragalysis_retrospective/20240417_multi_pose_docking_self_docking/$LSB_JOBINDEX.sdf" \
--overwrite \
--num-poses 50
